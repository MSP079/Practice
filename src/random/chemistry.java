...
public class chemistry {
    public static void main(String args[]) {
        ...
        String inputWord = myScanner.nextLine();
    ...
    /**
    * @param word the word that we want to re—spell using abbrevications of elements in
    the periodic table
    * @param elements an array that contains the abbreviations of elements in the
    periodic table
    iv
    ...
    * 1. Word represents the word that we want to re-spell using abbreviation of the
    elements from
    * the periodic table.

    * 2. Elements represents possible element abbreviations that you can use to re—spell
    the word
    *
 
    * The function needs to return a String representing the word that you have re—
    sprelled
